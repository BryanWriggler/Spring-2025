...
\begin{itemize}
    ...
    So, the alternating property is checked. Now, if given $u\in\mathbb{C}$, with $k_1,k_2\in\mathbb{R}$ satisfying $u=k_1w_1+k_2w_2$, then we get the following:
    $$A(z+u,w)=A((t_1w_1+t_2w_2)+(k_1w_1+k_2w_2),s_1w_1+s_2w_2)$$
    $$A((t_1+k_1)w_1+(t_2+k_2)w_2,s_1w_1+s_2w_2) = \det\begin{pmatrix}
        (t_1+k_1) & s_1\\
        (t_2+k_2) & s_2
    \end{pmatrix}$$
    $$ = (t_1+k_1)s_2 - (t_2+k_2)s_1 = (t_1s_2-t_2s_1)+(k_1s_2-k_2s_1)$$
    $$=\det\begin{pmatrix}t_1&s_1\\t_2&s_2\end{pmatrix} + \det\begin{pmatrix}k_1&s_1\\k_2&s_2\end{pmatrix}$$
    $$ = A(t_1w_1+t_2w_2,s_1w_1+s_2w_2)+ A(k_1w_1+k_2w_2,s_1w_1+s_2w_2)$$
    $$= A(z,w)+A(u,w)$$
