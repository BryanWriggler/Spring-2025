...
\titlegraphic{\includegraphics[width=0.06\textwidth]{lie.png}}
...
\begin{columns}
   ...
   \block{Acknowledgements \& Reference}{
        \vspace*{-1em}
        I want to thank mentor Arthur Jiang for the effort and insights on the materials and the project, as well as UCSB Math DRP for this opportunity. 
