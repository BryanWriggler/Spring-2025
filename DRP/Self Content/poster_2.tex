...
\begin{columns}
    ...
    \block{Lie Algebra on a Lie Group}{
        ...
        \begin{exampleBox}
            ...
            Given $GL_n(\mathbb{R})\subset M_n(\mathbb{R})$, since $M_n(\mathbb{R})\cong \mathbb{R}^{n^2}$ and $GL_n(\mathbb{R})$ is an open subset, it's a natural smooth manifold with dimension $n^2$. The product of matrices and inversion are smooth maps, so $GL_n(\mathbb{R})$ is a Lie Group.
