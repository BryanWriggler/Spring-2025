...
\begin{columns}
    ...
    \block{Lie Algebra on a Lie Group}{
        ...
        \begin{exampleBox}
            ...
            Given $GL_n(\mathbb{R})\subset M_n(\mathbb{R})$, since $M_n(\mathbb{R})\cong \mathbb{R}^{n^2}$ and $GL_n(\mathbb{R})$ is an open subset, it's a natural smooth manifold with dimension $n^2$. Which, the product of invertible matrices and inversion are smooth maps, so $GL_n(\mathbb{R})$ is a Lie Group.
   ...
   \block{Acknowledgements \& Reference}{
        \vspace*{-1em}
        I want to thank my mentor Arthur Jiang for the effort and insights on the materials and this project, as well as UCSB Math DRP for this opportunity. Also, check out the cool project of my peer \textbf{Siyu Chen's} poster about Lie Group and Lie Algebra's applications in physics!
